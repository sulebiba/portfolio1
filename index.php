        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <form action="form.php" method="post" onsubmit="return validate()">
                <input id="name" name="name" type="text" placeholder="First Name" class="tm-input" required />
                ...
                <button type="submit" class="btn tm-btn-submit" name="submit">Submit</button>
              </form>
            </div>
          ...
          <p class="mb-0">
          Copyright &copy; 2020 Company Name. </p>
        </footer>
